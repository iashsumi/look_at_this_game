...
export default class Article extends Vue {
  ...
  private created () {
    ...
    this.$store.dispatch('fetchArticle', id).then(() => {
      ...
      item2.setAttribute('property', 'og:url')
      ...
      item3.setAttribute('property', 'og:type')
      ...
      item4.setAttribute('property', 'og:title')
      ...
      item5.setAttribute('property', 'og:description')
      ...
      item6.setAttribute('property', 'og:site_name')
      ...
      item7.setAttribute('property', 'og:image')
